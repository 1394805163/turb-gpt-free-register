...
# ---------- curl_cffi 模拟浏览器 ----------
# 2026-09-17：Cloudflare 已开始挑战 chrome146 及更低的 TLS 指纹
# （实测 chrome136/146 -> 403，chrome150 -> 302）；UA、Client Hints、JS
# navigator 必须同步为 150，不能出现跨版本拼接指纹。
