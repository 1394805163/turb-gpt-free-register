...
GENERIC_API_PROXY: str = ""  # 留空=按 pick_proxy() 走注册出口选路；仅显式填写时才固定代理
...
# ============================================================
# iCloud Hide My Email aliases + iCloud IMAP
# ============================================================
...
ICLOUD_IMAP_USERNAME = env_str("ICLOUD_IMAP_USERNAME", "")
ICLOUD_IMAP_PASSWORD = env_str("ICLOUD_IMAP_PASSWORD", "")
ICLOUD_REQUEST_TIMEOUT = 30
ICLOUD_MESSAGE_LIMIT = 6
ICLOUD_INITIAL_SCAN_LIMIT = 20
ICLOUD_RESELECT_INTERVAL = 12
ICLOUD_RECONNECT_INTERVAL = 18
ICLOUD_CLOCK_SKEW_SECONDS = 30
...
apply_env_overrides(globals(), {'OTP_SINGLE_WAIT': 'int'})
OMNIMAIL_BASE: str = ""  # OmniMail 取码链接基址（完整导出用；留空时按邮箱池 code_url 输出）

apply_env_overrides(globals(), {'USE_EMAIL_SERVICE': 'bool', 'OTP_MAX_WAIT': 'int', 'OTP_POLL_INTERVAL': 'int', 'EMAIL_SOURCE': 'str', 'IMAP_MAILBOX': 'str', 'EMAIL_DOMAIN': 'str', 'QQ_EMAIL': 'str', 'QQ_IMAP_PASSWORD': 'str', 'GPTMAIL_API_KEY': 'str', 'OUTLOOK_FETCH_MODE': 'str', 'MAIL_NEST_API_KEY': 'str', 'MAIL_NEST_PROJECT_CODE': 'str', 'CLOUDFLARE_API_BASE': 'str', 'CLOUDFLARE_API_KEY': 'str', 'CLOUDFLARE_AUTH_MODE': 'str', 'CLOUDFLARE_CUSTOM_AUTH': 'str', 'CLOUDFLARE_PATH_DOMAINS': 'str', 'CLOUDFLARE_PATH_ACCOUNTS': 'str', 'CLOUDFLARE_PATH_TOKEN': 'str', 'CLOUDFLARE_PATH_MESSAGES': 'str', 'CLOUDFLARE_DEFAULT_DOMAINS': 'list_str_multiline', 'CLOUDFLARE_REQUEST_TIMEOUT': 'int', 'CLOUDFLARE_NAME_LENGTH': 'int', 'CLOUDMAIL_API_BASE': 'str', 'CLOUDMAIL_ADMIN_EMAIL': 'str', 'CLOUDMAIL_PASSWORD': 'str', 'CLOUDMAIL_TOKEN_PATH': 'str', 'CLOUDMAIL_AUTH_TOKEN': 'str', 'CLOUDMAIL_DOMAINS': 'list_str_multiline', 'CLOUDMAIL_AUTO_ADD_USER': 'bool', 'CLOUDMAIL_RANDOM_LOCAL_LENGTH': 'int', 'ICLOUD_MAILBOXES_FILE': 'str', 'ICLOUD_IMAP_HOST': 'str', 'ICLOUD_IMAP_PORT': 'int', 'ICLOUD_IMAP_MAILBOX': 'str', 'ICLOUD_IMAP_USERNAME': 'str', 'ICLOUD_IMAP_PASSWORD': 'str', 'ICLOUD_REQUEST_TIMEOUT': 'int', 'ICLOUD_MESSAGE_LIMIT': 'int', 'ICLOUD_INITIAL_SCAN_LIMIT': 'int', 'ICLOUD_RESELECT_INTERVAL': 'int', 'ICLOUD_RECONNECT_INTERVAL': 'int', 'ICLOUD_CLOCK_SKEW_SECONDS': 'int', 'REMAIL_API_BASE': 'str', 'REMAIL_API_KEY': 'str', 'REMAIL_PROJECT_ID': 'int', 'REMAIL_EMAIL_SUFFIX': 'str', 'REMAIL_SERVICE_MODE': 'str', 'REMAIL_SUPPLY_POLICY': 'str', 'REMAIL_ORDER_WAIT_SECONDS': 'int', 'REMAIL_REQUEST_TIMEOUT': 'int', 'OTP_SETTLE_SECONDS': 'int', 'GENERIC_API_PROXY': 'str', 'OMNIMAIL_BASE': 'str'})
