...
# 查活快速路径：先协议 RT 刷新（约 1 秒、不开浏览器），失败自动回退浏览器登录。
# 默认关闭；启用前建议先观察一批 rt_refresh 结果与浏览器查活的一致性。
LIVE_CHECK_FAST_REFRESH: bool = False
